                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <select class="form-control m-b" name="title" required>
                                                        <option <?php if ($member_data['title'] == "Mr") {
    echo "selected";
} ?> value="Mr" >Mr.</option>
                                                        <option <?php if ($member_data['title'] == "Mrs") {
    echo "selected";
} ?> value="Mrs">Mrs.</option>
                                                        <option <?php if ($member_data['title'] == "Dr") {
    echo "selected";
} ?> value="Dr">Dr.</option>
                                                        <option <?php if ($member_data['title'] == "Prof") {
    echo "selected";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <select class="form-control m-b" name="memberType" >
                                                        <option <?php if ($member_data['memberType'] == 0) {
    echo "checked";
} ?> value="0	">Member Only</option>
                                                        <option <?php if ($member_data['memberType'] == 1) {
    echo "checked";
} ?> value="1">Member and Share Holder</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-10">
                                            ...
                                            <div class="col-sm-7 no_padding" style="margin-top:8px;margin-bottom:8px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <label > <input name="gender" <?php if ($member_data['gender'] == "M") {
    echo "checked";
} ?> class="i-checks" type="radio" value="M" >Male</label>
                                                        <label > <input name="gender" <?php if ($member_data['gender'] == "F") {
    echo "checked";
} ?> class="i-checks" type="radio" value="F"> Female</label>
                                                    </div>
                                                </div>											
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control m-b" name="marital_status" >
                                                            <option <?php if ($member_data['marital_status'] == "Single") {
    echo "selected";
} ?> value="Single">Single</option>
                                                            <option <?php if ($member_data['marital_status'] == "Married") {
    echo "selected";
} ?> value="Married">Married</option>
                                                            <option <?php if ($member_data['marital_status'] == "Divorced") {
    echo "selected";
} ?> value="Divorced">Divorced</option>
                                                            <option <?php if ($member_data['marital_status'] == "Windowed") {
    echo "selected";
} ?> value="Windowed">Windowed</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
...
if ($all_id_cardtype) {
    foreach ($all_id_cardtype as $single) {
        ?>
                                                                <option <?php if ($member_data['id_type'] == $single['id']) {
            echo "selected";
        } ?> value="<?php echo $single['id']; ?>" ><?php echo $single['id_type']; ?></option>
        <?php
    }
}
?>
