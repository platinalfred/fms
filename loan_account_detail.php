	<div id="loan_account_details" class="row" data-bind="with: account_details">
		<div class="col-lg-5">
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							<thead>
								<tr><th>Ref.</th><th>Description</th><th>Cr</th><th>Dr</th></tr>
							</thead>
							<tbody>
								<tr> <td> </td> <td> </td> <td> </td> <td data-bind="text: penaltyRateChargedPer"></td> </tr>
							</tbody>
							<tfoot>
								<tr>
									<th>Total</th><th data-bind="text: penaltyRateChargedPer">10,000</th><th data-bind="text: penaltyRateChargedPer">10,000</th><th data-bind="text: penaltyRateChargedPer">10,000</th>
								</tr>
							</tfoot>
						</table>
					</div>
