...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2017 at 04:30 PM
...
CREATE TABLE `employment` (
  ...
  `nature_of_employment` int(11) NOT NULL,
...
INSERT INTO `member` (`id`, `personId`, `active`, `branch_id`, `memberType`, `dateAdded`, `added_by`, `comment`, `dateModified`, `modifiedBy`) VALUES
