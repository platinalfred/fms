            ...
            <div class="modal-body">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h2><strong>Add Member</strong></h2>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row" style="margin-top:10px;margin-bottom:10px;">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-1"><input id="acceptTerms" name="acceptTerms" type="checkbox" class="i-checks" required> </div>
                                                        <div class="col-lg-11">	<label for="acceptTerms">I Accept that all member details above are correct.</label></div>
                                                    </div>
                                                </div>

                                                <div class="col-lg-4">
                                                    <button class="btn btn-lg btn-primary ladda" data-style="contract" type="submit">Add Member</button>
                                                </div>
                                            </fieldset>
                                        </div>
                                        </form>
