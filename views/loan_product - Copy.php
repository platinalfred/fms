                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="loanProductForm" class="form-horizontal">
                                ...
                                <div class="form-group" data-bind="visible: parseInt(penaltyCalculationMethod.id)>1">
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-7">
										...
										<div class="col-sm-4">
											<select class="form-control m-b" id="penaltyRateChargedPer" name="penaltyRateChargedPer" data-bind='css: {required: penaltyTolerancePeriod()}, options: taxRateSourceOptions, optionsText: "desc", optionsCaption: "Select...", optionsAfterRender: setOptionValue("id"), value: penaltyRateChargedPer'>
										</select>
										</div>
                                    </div>
                                </div>
                                ...
                                <div class="hr-line-dashed"></div>
								<div class="form-group" data-bind="visible: existingProductFees().length > 0">
										...
										<table class="table table-condensed table-stripped">
											...
											<tbody data-bind="foreach: $root.existingProductFees">
												<tr>
													...
													<td data-bind='text: amountCalculatedAs'></td>
                                ...
                                <div class="hr-line-dashed"></div>
								<div class="form-group" data-bind="visible: newProductFees().length > 0">
									<div class="table-responsive">
