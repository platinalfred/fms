                ...
                dTable = $('#staffTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'Names', render: function (data, type, full, meta) {
                                return full.firstname + ' ' + full.othername + ' ' + full.lastname;
                            }},
                        {data: 'phone'},
                        {data: 'id_number'},
                        {data: 'dateofbirth', render: function (data, type, full, meta) {
                        ...
                        {data: 'status', render: function (data, type, full, meta) {
                                if (data == 1) {
                                    ...
                                    return "<span class='label label-danger activate' id=" + full.id + " style='cursor:pointer;'>Inactive</span>";
                                }
                            }},
                        {data: 'id', render: function (data, type, full, meta) {
                                return '<a  id=' + data + ' class="btn btn-white btn-sm edit"><i class="fa fa-pencil"></i> Edit </a> <a class="btn btn-sm btn-danger delete" id=' + data + '><i class="fa fa-trash"></i> </a>';
                            }}
                    ],
                    buttons: [
                        {
