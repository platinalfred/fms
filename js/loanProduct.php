...
<script type="text/javascript">
	...
	var Product = function() {
		...
		self.taxCalculationMethodOptions = [{"id":1, "desc":"Inclusive"},{"id":1, "desc":"Exclusive"}]];
		...
		self.feeTypes = ko.observableArray([{"id":1, "typeName":"Fixed fee"}]);
