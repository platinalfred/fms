			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 " style="border-top:1px solid #09A; padding-top:10px;">
						<p>
							<a  href="add_loan_account.php?id=<?php echo $member_data['personId']; ?>" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Apply for a loan</a>
							...
							<a  href="?id=<?php echo  $member_data['personId']; ?>&task=deposit.add" class="btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Deposit</a>
