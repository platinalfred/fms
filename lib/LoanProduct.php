...
class LoanProduct extends Db {
    ...
    protected static $table_fields2 = array("`id`", "productName", "description", "productType", "active", "availableTo", "defAmount", "minAmount", "maxAmount", "maxTranches", "defInterest", "minInterest", "maxInterest", "repaymentsFrequency", "repaymentsMadeEvery", "defRepaymentInstallments", "minRepaymentInstallments", "maxRepaymentInstallments", "initialAccountState", "defGracePeriod", "minGracePeriod", "maxGracePeriod", "minCollateral", "minGuarantors", "defOffSet", "minOffSet", "maxOffSet", "penaltyCalculationMethodId", "penaltyTolerancePeriod", "penaltyRateChargedPer", "defPenaltyRate", "minPenaltyRate", "maxPenaltyRate", /*"daysOfYear", "taxRateSource", "taxCalculationMethod", "linkToDepositAccount",*/ "createdBy", "dateCreated", "modifiedBy");
    ...
    public function addLoanProduct($data) {
        $fields = array_slice(self::$table_fields2, 1);
