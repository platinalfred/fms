...
if (isset($_POST['origin'])) {
    switch ($_POST['origin']) {
        ...
        case 'deposit_product':
            ...
            $data['existingDepositProductFees'] = $deposit_product_fee_obj->findAll();
            echo json_encode($data);
            break;
        case 'loan_product_fee_types':
            $feeType = new FeeType();
        ...
        case 'deposit_product_feens':
            ...
            $where_clause = (isset($_POST['depositProductId']) && is_numeric($_POST['depositProductId']))?("`depositProductId`=".$_POST['depositProductId']):"";
            $data['depositProductFeens'] = $deposit_product_feen_obj->findAllLPFDetails($where_clause);
            echo json_encode($data);
            break;
        case 'loan_account':
