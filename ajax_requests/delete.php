...
if (isset($_GET['tbl'])) {
    ...
    switch ($_GET['tbl']) {
        ...
        case "access_level":
            ...
            break;
        case "saccogroup":
            if (isset($_GET['class']) && $_GET['class']=="turn_off" && $db->turnOff("saccogroup", "id=" . $_GET['id'])) {
                $msg = "success";
            }
            if (isset($_GET['class']) && $_GET['class']=="delete_me" ) {
                require_once("../lib/SaccoGroup.php");
                $sacco_group_obj = new SaccoGroup();
                if($sacco_group_obj->deleteSaccoGroup( $_GET['id'])){
                    $msg = "success";
                }
            }
            break;
