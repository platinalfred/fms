...
<?php if (isset($_SESSION['branch_credit']) || isset($_SESSION['management_credit']) || isset($_SESSION['executive_board']) || isset($_SESSION['branch_manager']) || isset($_SESSION['loans_officer']) || isset($_SESSION['admin'])) { ?>
    <!-- ko if: status<4 -->
