						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-md-4">
									...
									<h3 class="no-margins"><a title="Details" data-bind="text:curr_format(parseInt(figures.loan_portfolio)), attr:{href:'view_loans.php?status=4&startdate='+$root.startDate()+'&enddate='+$root.endDate()}">40,642</a></h3>
								...
								<div class="col-md-4">
									...
									<h3 class="no-margins"><a title="Details" data-bind="text:curr_format(parseInt(figures.loan_penalty)), attr:{href:'view_loans.php?status=4&startdate='+$root.startDate()+'&enddate='+$root.endDate()}">40,642</a></h3>
								...
								<div class="col-md-4">
									...
									<h3 class="no-margins"><a title="Details" data-bind="text:curr_format(parseInt(figures.loan_payments)), attr:{href:'view_loans.php?status=4&startdate='+$root.startDate()+'&enddate='+$root.endDate()}">20,612</a></h3>
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-md-4">
									<small>Savings</small>
									<h3 class="no-margins"><a title="Details" data-bind="text:curr_format(parseInt(figures.savings)), attr:{href:'view_savings.php?startdate='+$root.startDate()+'&enddate='+$root.endDate()}">20,612</a></h3>
								...
								<div class="col-md-4">
									<small>Members</small>
									<h3 class="no-margins"><a title="Details" data-bind="text: figures.members, attr:{href:'members.php?startdate='+$root.startDate()+'&enddate='+$root.endDate()}">386,200</a></h3>
								...
								<div class="col-md-4">
									...
									<h3 class="no-margins"><a title="Details" data-bind="text: curr_format(parseInt(figures.total_scptions)), attr:{href:'view_subscriptions.php?status=1&startdate='+$root.startDate()+'&enddate='+$root.endDate()}">80,800</a></h3>
